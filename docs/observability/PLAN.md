...
The canonical architecture and phased plan is maintained in [documentation/PLAN_OBSERVABILIDAD_OPZIO_ERP.md](../../documentation/PLAN_OBSERVABILIDAD_OPZIO_ERP.md).
