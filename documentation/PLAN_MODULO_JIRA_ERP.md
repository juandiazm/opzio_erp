...
= suma de story_points de issues cuya fecha `jira_created_at` o `jira_updated_at` cae dentro del rango; los estados solo restringen el resultado cuando se seleccionan
```
