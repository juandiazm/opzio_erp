...
## Done
- ERP-001 module boundary under `app/Domain/Observability`.
...
## Last validation
Date: 2026-08-14
Tests: `php artisan test --filter=observability_api_test` passed with 8 tests; Laravel Mix production build passed.
