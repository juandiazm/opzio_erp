...
class servers_api_test extends TestCase
{
    private $agent;
    ...
    protected function setUp(): void
    {
        ...
        $this->agent = servers_agent::create([
            'host_id' => $host->id,
            'agent_id' => 'test-agent',
            'enabled' => true,
        ]);
    ...
    {
        $this->getJson('/api/internal/servers/v1/health')->assertStatus(401);
    }
    ...
    public function test_health_rejects_non_loopback_requests()
    {
        $this->withServerVariables(['REMOTE_ADDR' => '10.0.0.8'])
            ...
            ->getJson('/api/internal/servers/v1/health')
            ->assertStatus(403);
    }

    public function test_payload_limit_is_enforced_without_content_length_header()
    {
        config(['services.servers.max_payload_bytes' => 10]);

        $this->withHeaders($this->observerHeaders())
            ->postJson('/api/internal/servers/v1/heartbeat', [
                'agent_id' => 'test-agent',
    ...
    public function test_health_and_config_are_available_to_a_registered_loopback_agent()
    {
        ...
        $this->withHeaders($headers)
            ->getJson('/api/internal/servers/v1/config')
            ->assertOk()
    ...
    public function test_discovery_registers_projects_and_is_idempotent()
    {
        ...
        $firstResponse = $this->withHeaders($this->observerHeaders())->postJson(
            '/api/internal/servers/v1/discovery',
            [
                'agent_id' => 'test-agent',
    ...
    public function test_ingest_is_idempotent_by_batch_id()
    {
        ...
        $firstResponse = $this->withHeaders($this->observerHeaders())->postJson(
            '/api/internal/servers/v1/ingest',
            $payload
        );
        ...
        $this->assertSame(1, DB::table('servers_ingest_batches')->count());
        $this->assertSame(1, DB::table('servers_host_samples')->count());
        $this->assertSame(1, DB::table('servers_project_samples')->count());
        $this->assertSame(1, DB::table('servers_http_buckets')->count());
    }

    public function test_ingest_rejects_projects_outside_the_active_registry()
    {
        $this->withHeaders($this->observerHeaders())
            ->postJson('/api/internal/servers/v1/ingest', [
                'agent_id' => 'test-agent',
    ...
    public function test_heartbeat_updates_agent_health()
    {
        ...
        $this->assertDatabaseHas('servers_agents', [
            'agent_id' => 'test-agent',
            'version' => '0.1.0',
            'commit_sha' => 'abc123',
            'spool_bytes' => 128,
    ...
    public function test_dashboard_lists_filtered_project_metrics_with_pagination()
    {
        ...
        DB::table('servers_agents')->where('agent_id', 'test-agent')->update([
        ...
        $response = $this->withoutMiddleware()->postJson('/admin/servers/get-page', [
            'minutes' => 60,
            'health' => 'reporting',
            'search' => 'test-project',
            'pagination' => [
        ...
        $secondPageResponse = $this->withoutMiddleware()->postJson('/admin/servers/get-page', [
            'minutes' => 60,
            'pagination' => [
                'page' => 2,
                'per_page' => 5,
        ...
        $exportResponse = $this->withoutMiddleware()->get('/admin/servers/export?minutes=60&search=test-project');
    ...
    {
        $alphaProject = servers_project::create([
            'host_id' => $this->agent->host_id,
            'key' => 'alpha-project',
            'name' => 'Alpha project',
        ...
        $zuluProject = servers_project::create([
            'host_id' => $this->agent->host_id,
            'key' => 'zulu-project',
            'name' => 'Zulu project',
        ...
        $defaultResponse = $this->withoutMiddleware()->postJson('/admin/servers/get-page', [
            'minutes' => 60,
            'pagination' => [
                'page' => 1,
                'per_page' => 5,
        ...
        $nameAscendingResponse = $this->withoutMiddleware()->postJson('/admin/servers/get-page', [
            'minutes' => 60,
            'sort_by' => 'name',
            'sort_direction' => 'asc',
            'pagination' => [
        ...
        $trafficResponse = $this->withoutMiddleware()->postJson('/admin/servers/get-page', [
            'minutes' => 60,
    ...
    {
            $this->assertSame(0, Artisan::call('servers:host', [
                'key' => 'cli-host',
                'name' => 'CLI host',
                '--hostname' => 'cli-host.local',
            ]));
            $this->assertSame(0, Artisan::call('servers:agent', [
                'agent_id' => 'cli-agent',
                'host_key' => 'cli-host',
            ]));
            $this->assertSame(0, Artisan::call('servers:project', [
                'host_key' => 'cli-host',
                'key' => 'cli-project',
                'name' => 'CLI project',
            ...
            $this->assertDatabaseHas('servers_hosts', ['key' => 'cli-host'], 'sqlite');
            $this->assertDatabaseHas('servers_agents', ['agent_id' => 'cli-agent'], 'sqlite');
            $this->assertDatabaseHas('servers_projects', [
                'key' => 'cli-project',
                'fpm_pool' => 'cli_pool',
                'attribution_mode' => 'pool',
