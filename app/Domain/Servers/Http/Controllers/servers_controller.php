...
use App\Domain\Servers\Models\servers_event;
use App\Domain\Servers\Models\servers_host_sample;
use App\Domain\Servers\Models\servers_http_bucket;
use App\Domain\Servers\Models\servers_ingest_batch;
use App\Domain\Servers\Models\servers_project;
use App\Domain\Servers\Models\servers_project_sample;
use App\Domain\Servers\Models\servers_storage_sample;
...
class servers_controller extends Controller
{
    ...
    public function ingest(Request $request)
    {
        ...
        $existingBatch = servers_ingest_batch::where('batch_id', $validated['batch_id'])->first();
    ...
    public function discovery(Request $request)
    {
        ...
        DB::transaction(function () use ($agent, $validated, &$created, &$updated, &$projectKeys) {
            foreach ($validated['projects'] as $discovered) {
                ...
                $project = servers_project::where('host_id', $agent->host_id)
    ...
    private function findAgent(string $agentId): ?servers_agent
    {
        return servers_agent::with('host')
