...
// preventing duplicate registrations when navigating between pages.
if ('serviceWorker' in navigator && !sessionStorage.getItem('__pwaRegistered')) {
    sessionStorage.setItem('__pwaRegistered', '1');
    ...
    if (installButton) {
        ...
        installButton.addEventListener('click', async (e) => {
            ...
            if (deferredPrompt) {
                ...
                // Save that user already interacted with the prompt
...
if (!sessionStorage.getItem('__pwaInitialized')) {
    sessionStorage.setItem('__pwaInitialized', '1');
