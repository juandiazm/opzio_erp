...
function getAllUsers(){
    GetMethodFunction('/admin/users/all',null,function(response){
        let appendData = '<option value="">Todos</option>';
        $.each(response.data,function(index,value){
            appendData += '<option value="'+value.id+'"'+(typeof user_id !== 'undefined' && value.id==user_id?' selected':'')+'>'+value.name+' '+value.lastname+'</option>';
        });
...
function getTraceability(index){
    ...
    PostMethodFunction('/admin/users/traceability',DataSend,null, showTraceability,null, {container:container, index:index});
    setTimeout(() => {
