...
function getAllUsers(){
    GetMethodFunction('/admin/clients/users/all',null,function(response){
...
function getTraceability(index){
    ...
    PostMethodFunction('/admin/clients/users/traceability',DataSend,null, showTraceability,null, {container:container, index:index});
    setTimeout(() => {
