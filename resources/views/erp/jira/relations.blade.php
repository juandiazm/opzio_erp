    ...
    <div class="jira-relations-grid">
        <section class="jira-panel jira-relation-workspace" data-jira-project-workspace hidden>
            ...
            <form data-jira-project-relation-form>
                ...
                <div class="jira-project-hours-setting"><label class="jira-field"><span>Horas por Story Point</span><input type="number" name="story_point_hours_multiplier" data-jira-hours-multiplier min="0.01" max="9999" step="0.01" value="1"></label><small>Las HU nuevas usarán este multiplicador. Las horas editadas manualmente se conservan.</small></div>
