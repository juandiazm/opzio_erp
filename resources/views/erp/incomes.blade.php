...
<nav>
    <div class="nav nav-tabs principal-nav-tabs" id="nav-tab" role="tablist">
        ...
        <button class="nav-link" id="nav-goals-tab" data-bs-toggle="tab" data-bs-target="#nav-goals" type="button" role="tab" aria-controls="nav-goals" aria-selected="false">Metas</button>
...
<div class="tab-content" id="nav-tabContent">
    @include('erp.incomes.list')
    @include('erp.incomes.create')
    @include('erp.incomes.goals')
    @include('erp.incomes.update')
    @include('erp.incomes.traceability')
</div>
