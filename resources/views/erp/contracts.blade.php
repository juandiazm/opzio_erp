...
<nav>
    <div class="nav nav-tabs principal-nav-tabs" id="nav-tab" role="tablist">
        ...
        <button class="nav-link" id="nav-schedules-tab" data-bs-toggle="tab" data-bs-target="#nav-schedules" type="button" role="tab" aria-controls="nav-schedules" aria-selected="false">Programaciones</button>
...
<div class="tab-content" id="nav-tabContent">
    ...
    @include('erp.contracts.schedules')
