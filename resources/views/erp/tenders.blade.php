...
<nav>
    <div class="nav nav-tabs principal-nav-tabs" id="tenders-nav-tab" role="tablist">
        ...
        <button class="nav-link" id="tenders-pipeline-tab" data-bs-toggle="tab" data-bs-target="#tenders-pipeline" type="button" role="tab" aria-controls="tenders-pipeline" aria-selected="false">Seguimiento</button>
    </div>
</nav>
