<form id="notifications-sms-form" class="notifications-compose-form d-none">
    ...
    <div class="notifications-recipient-section">
        ...
        <label class="notifications-field"><span>Etiquetas de contacto</span><select id="notifications-sms-tags" class="form-select" multiple size="4" aria-label="Etiquetas para SMS"></select></label>
