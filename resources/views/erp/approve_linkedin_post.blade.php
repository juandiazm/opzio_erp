...
<script src="{{ asset('js/erp/approve_linkedin_post/approve_linkedin_post.js') }}" defer></script>
<!-- Styles -->
<link href="{{ asset('css/erp/approve_linkedin_post/approve_linkedin_post.css') }}" rel="stylesheet">
