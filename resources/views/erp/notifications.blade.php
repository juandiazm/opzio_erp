...
<div class="notifications-page">
    <nav>
        <div class="nav nav-tabs principal-nav-tabs" id="nav-tab" role="tablist">
            ...
            <button class="nav-link" id="notifications-whatsapp-tab" data-bs-toggle="tab" data-bs-target="#notifications-whatsapp-pane" type="button" role="tab" aria-controls="notifications-whatsapp-pane" aria-selected="false"><i class="fa-brands fa-whatsapp"></i> WhatsApp <span class="notifications-tab-unread d-none" id="notifications-whatsapp-unread-tab-badge">0</span></button>
        </div>
    </nav>
