...
<div class="email-wrapper">
    <div class="email-container">
        ...
        <div class="email-content">
            <h1 class="email-greeting">Recordatorio de pago</h1>
            <p class="email-text">Estimados <strong>{{ $Data['income']['client_name'] }}</strong>, te compartimos los datos de tu orden de compra pendiente.</p>
            ...
            <div class="btn-wrap">
                <a href="{{ $Data['income']['payment_link'] }}" class="email-button">Pagar en Línea</a>
            </div>
