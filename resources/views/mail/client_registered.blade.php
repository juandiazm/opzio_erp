...
<div class="email-wrapper">
    <div class="email-container">
        ...
        <div class="email-content">
            <h1 class="email-greeting">Nuevo cliente registrado</h1>
            <p class="email-text">Se ha registrado un nuevo cliente en la aplicación. A continuación los datos del cliente:</p>
            <div class="info-box">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="detail-row"><tr>
                    ...
                    <td align="right" class="detail-value">{{ $Data['client']['email'] }}</td>
                </tr></table>
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="detail-row"><tr>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="detail-row"><tr>
                    ...
                    <td align="right" class="detail-value">{{ $Data['client']['country']['name'] }}</td>
                </tr></table>
            </div>
        </div>
