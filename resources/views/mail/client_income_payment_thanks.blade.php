...
<div class="email-wrapper">
    <div class="email-container">
        ...
        <div class="email-content">
            <h1 class="email-greeting">Gracias por tu pago</h1>
            <p class="email-text">Hola <strong>{{ $Data['income']['client_name'] }}</strong>, confirmamos la recepción de tu pago. Agradecemos tu confianza.</p>
            <div class="info-box">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="detail-row"><tr>
                    <td class="detail-label">Factura</td>
                    <td align="right" class="detail-value">{{ $Data['income']['bill_name'] ?? 'N/A' }}</td>
                </tr></table>
                @if(isset($Data['income']['siigo_invoice_url']) && $Data['income']['siigo_invoice_url'])
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="detail-row"><tr>
                    <td class="detail-label">F.E</td>
                    <td align="right" class="detail-value"><a href="{{ $Data['income']['siigo_invoice_url'] }}" target="_blank" class="footer-link">Ver Factura Electrónica</a></td>
                </tr></table>
                @endif
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="detail-row"><tr>
                    <td class="detail-label">Fecha de pago</td>
                    <td align="right" class="detail-value">{{ $Data['income']['payment_date'] }}</td>
                </tr></table>
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="detail-row"><tr>
                    <td class="detail-label">Valor pagado</td>
                    <td align="right" class="detail-value">COP ${{ number_format($Data['income']['bill_final_value'] ?? $Data['income']['total'],0,',','.') }}</td>
                </tr></table>
            </div>
            <p class="email-text">Si requiere soporte o información adicional, nuestro equipo está disponible para ayudarle.</p>
        </div>
