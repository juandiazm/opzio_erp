...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .info-box { background-color: #F7F7F8; padding: 20px; margin: 24px 0; border-radius: 4px; }
...
<div class="email-wrapper">
    <div class="email-container">
        ...
        <div class="email-content">
            ...
            <p class="email-text">Adjunto encontrarás el reporte de marketing generado para <strong>{{ $Data['client_name'] }}</strong>.</p>
            <div class="info-box">
                <div class="info-box-title">Datos del reporte</div>
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="detail-row"><tr>
                    <td class="detail-label">Cliente</td>
                    <td align="right" class="detail-value primary">{{ $Data['client_name'] }}</td>
                </tr></table>
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="detail-row"><tr>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="detail-row"><tr>
                    <td class="detail-label">Fecha de generación</td>
