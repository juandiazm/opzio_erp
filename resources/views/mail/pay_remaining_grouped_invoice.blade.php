...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .ia-message-box { background-color: #EEF3FF; border-left: 3px solid #220245; padding: 16px 20px; margin: 20px 0; border-radius: 0 4px 4px 0; font-size: 14px; color: #333333; line-height: 1.6; }
        ...
        .client-name { font-size: 16px; font-weight: 600; color: #220245; }
        ...
        .income-card-title { font-size: 13px; font-weight: 700; color: #220245; margin-bottom: 12px; border-bottom: 1px solid #E0E0E0; padding-bottom: 8px; }
        ...
        .email-button { display: inline-block; padding: 10px 24px; background-color: #220245; color: #FFFFFF !important; text-decoration: none; border-radius: 4px; font-size: 13px; font-weight: 600; }
        .email-button-secondary { display: inline-block; padding: 10px 24px; background-color: #FFFFFF; color: #220245 !important; text-decoration: none; border-radius: 4px; font-size: 13px; font-weight: 600; border: 1px solid #220245; }
        .summary-box { background-color: #220245; border-radius: 6px; padding: 16px 20px; margin: 20px 0; color: #FFFFFF; text-align: center; }
...
<div class="email-wrapper">
    <div class="email-container">
        ...
        <div class="email-content">
            <h1 class="email-greeting">{{ count($Data['incomes']) > 1 ? 'Tus facturas electrónicas' : 'Tu factura electrónica' }}</h1>
            ...
            <p class="section-label">{{ count($Data['incomes']) > 1 ? 'Datos de tus facturas electrónicas:' : 'Datos de tu factura electrónica:' }}</p>
            @foreach($Data['incomes'] as $income)
            <div class="income-card">
                <div class="income-card-title">Factura Electrónica #{{ substr($income['unique_id'], -10) }}</div>
                ...
                <div class="btn-wrap">
                    ...
                    <a href="{{ $income['siigo_invoice_url'] }}" class="email-button-secondary" target="_blank">Ver Factura</a>
                    @endif
