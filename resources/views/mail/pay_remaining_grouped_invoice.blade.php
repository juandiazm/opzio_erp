...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .email-button-secondary { display: inline-block; padding: 10px 24px; background-color: #FFFFFF; color: #0153FF !important; text-decoration: none; border-radius: 4px; font-size: 13px; font-weight: 600; border: 1px solid #0153FF; }
