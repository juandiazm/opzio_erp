...
<div class="email-wrapper">
    <div class="email-container">
        ...
        <div class="email-content">
            <h1 class="email-greeting">Nuevo usuario en tu cuenta</h1>
            <p class="email-text">Hola <strong>{{ $Data['client_name'] }}</strong>, se ha agregado un nuevo usuario a tu panel de clientes.</p>
            <div class="info-box">
                <div class="info-box-title">Datos del nuevo usuario</div>
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="detail-row"><tr>
                    <td class="detail-label">Nombre</td>
                    <td align="right" class="detail-value primary">{{ $Data['client_user_name'] }}</td>
                </tr></table>
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="detail-row"><tr>
                    <td class="detail-label">Correo</td>
                    <td align="right" class="detail-value">{{ $Data['client_user_email'] }}</td>
                </tr></table>
            </div>
            <p class="email-text">Si no reconoces esta acción, por favor contacta a nuestro equipo de soporte inmediatamente.</p>
        </div>
