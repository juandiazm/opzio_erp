...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .report-item-title { font-size: 13px; font-weight: 700; color: #0153FF; margin-bottom: 10px; padding-bottom: 8px; border-bottom: 1px solid #E0E0E0; }
        ...
        .summary-box { background-color: #0153FF; border-radius: 6px; padding: 20px; margin: 24px 0; color: #FFFFFF; text-align: center; }
        ...
        <div class="email-content">
            ...
            <div class="report-item">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="detail-row"><tr>
                    ...
                    <td align="right" class="detail-value"><a href="{{ $message['siigo_invoice_url'] }}" target="_blank" style="color:#0153FF;text-decoration:none;font-weight:600;">Ver Factura Electrónica</a></td>
                </tr></table>
                @endif
