...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .info-box { background-color: #F7F7F8; border-left: 3px solid #220245; padding: 16px 20px; margin: 24px 0; border-radius: 0 4px 4px 0; }
        .info-box-title { font-size: 11px; color: #220245; text-transform: uppercase; letter-spacing: 1px; font-weight: 600; margin-bottom: 8px; }
...
<div class="email-wrapper">
    <div class="email-container">
        ...
        <div class="email-content">
            <h1 class="email-greeting">Tweet pendiente de aprobación</h1>
            <p class="email-text">Se ha generado un nuevo tweet para <strong>Twitter / X</strong> con inteligencia artificial. Revisa el contenido y apruébalo para publicarlo.</p>
            <img src="{{ $Data['image_url_complete'] }}" alt="Post Twitter" class="post-image">
            <div class="info-box">
                <div class="info-box-title">Contenido del tweet</div>
                <div class="info-value">{{ $Data['message'] }}</div>
            </div>
            <div class="divider"></div>
            <div class="email-button-container">
                <a href="{{ config('app.APP_URL').'api/twitter/approve/'.$Data['unique_id'] }}" class="email-button" target="_blank">Aprobar Tweet</a>
            </div>
        </div>
