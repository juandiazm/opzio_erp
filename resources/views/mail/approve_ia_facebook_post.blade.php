...
<div class="email-wrapper">
    <div class="email-container">
        ...
        <div class="email-content">
            <h1 class="email-greeting">Post de Facebook pendiente</h1>
            <p class="email-text">Se ha generado un nuevo post para <strong>Facebook</strong> con inteligencia artificial. Revisa el contenido y apruébalo para publicarlo.</p>
            <img src="{{ $Data['image_url'] }}" alt="Post Facebook" class="post-image">
            <div class="info-box">
            ...
            <div class="email-button-container">
                <a href="{{ config('app.APP_URL').'api/facebook/approve/'.$Data['unique_id'] }}" class="email-button" target="_blank">Aprobar Post</a>
            </div>
        </div>
