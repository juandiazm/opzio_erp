        ...
        <div class="email-content">
            ...
            <div class="income-card">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="detail-row"><tr>
                    ...
                    <td align="right" class="detail-value"><a href="{{ $income['siigo_invoice_url'] }}" target="_blank" style="color:#220245;text-decoration:none;font-weight:600;">Ver Factura Electrónica</a></td>
                </tr></table>
                @endif
