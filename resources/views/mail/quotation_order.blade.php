...
<div class="email-wrapper">
    <div class="email-container">
        ...
        <div class="email-content">
            <h1 class="email-greeting">¡Gracias por tu interés!</h1>
            <p class="email-text">Estimados <strong>{{ $Data['income']['client_name'] }}</strong>, adjunto encontrarás los datos de tu cotización.</p>
            @if(isset($Data['ia_message']) && $Data['ia_message'])
            <div class="ia-message-box">{{ $Data['ia_message'] }}</div>
            @endif
            <div class="info-box">
                <div class="info-box-title">Datos de tu cotización</div>
            ...
            <div class="btn-wrap">
                <a href="{{ $Data['income_url'] }}" class="email-button">Ver Cotización</a>
            </div>
