    ...
    <head>
        ...
        <style>
            ...
            #pdf-container{
                width: 100%;
                height: 100%;
                background-image: url('https://erp.ridder.com.co/images/api/clients/ensamble/diploma_fondo.jpg');
    ...
    <body>
        <div id="pdf-container">
            <div id="content-container">
                <img id="house-img" src="https://erp.ridder.com.co/images/api/clients/ensamble/diploma_logo.jpg" alt="">
                ...
                <img src="https://erp.ridder.com.co/images/api/clients/ensamble/diploma_firma completa.jpg" id="sign-img" alt="">
            </div>
        </div>
    </body>
</html>
